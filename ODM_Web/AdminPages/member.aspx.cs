...
public partial class AdminPages_member : System.Web.UI.Page
{
    ...
    protected void btn_img_delete_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            cm.Parameters.AddWithValue("@int_member_id", btn_img_delete.CommandArgument);
    ...
    protected void btn_search_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                string query = "where str_member_name like '" + txt_search_box.Text + "%'";
                binddata(query);
            }
        }
        catch (Exception ex)
        ...
        try
        {
            ...
            foreach (GridViewRow row in gvlist.Rows)
            {
                ...
                if (check.Checked)
                {
                    ...
                    objdal.int_member_id = Convert.ToInt16(id.Value);
