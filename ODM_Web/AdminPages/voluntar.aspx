<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPages/Admin.master" AutoEventWireup="true" CodeFile="voluntar.aspx.cs" Inherits="AdminPages_voluntar" %>
                            ...
                            <td colspan="3">
                                <asp:GridView ID="gvlist" runat="server" CssClass="table table-striped table-bordered bootstrap-datatable datatable"
                                    ...
                                    <Columns>
                                       ...
                                       <asp:BoundField DataField="str_voluntar_team_name" HeaderText="Voluntar Team Name" ReadOnly="True"
                                        ...
                                        <asp:BoundField DataField="int_contact" HeaderText="Contact"
