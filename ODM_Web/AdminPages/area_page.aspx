<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPages/Admin.master" AutoEventWireup="true"
    CodeFile="area_page.aspx.cs" Inherits="AdminPages_area_page" %>
                            ...
                            <table width="100%">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddl_district"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txt_area_name" runat="server"></asp:TextBox>
                                       <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txt_area_name"
                            ...
                            <td class="center">
                                <asp:GridView ID="gvlist" runat="server" CssClass="table table-striped table-bordered bootstrap-datatable datatable"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="str_district_name" HeaderText="District" ReadOnly="True"
                                            SortExpression="str_area_name" />
                                        <asp:BoundField DataField="str_area_name" HeaderText="Area" ReadOnly="True" SortExpression="str_area_name" />
                                        <asp:TemplateField HeaderText="Action">
                                            <EditItemTemplate>
                                                Recored not found
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:ImageButton ID="btn_img_edit" runat="server" CommandArgument='<%# Eval("int_area_id") %>'
                                                    Height="20px" ImageUrl="~/image/edit.jpg" OnClick="btn_img_edit_Click" Width="20px" />
                                                <asp:ImageButton ID="btn_img_delete" runat="server" CommandArgument='<%#Eval("int_area_id") %>'
                                                    CommandName="btn_img_delete" Height="20px" ImageUrl="~/image/delete.jpg" OnClick="btn_img_delete_Click"
                                                    OnClientClick="return confirm('Are you sure you want to Delete this Record?');"
                                                    Width="20px" />
                                                <asp:HiddenField ID="Hiddenid" runat="server" Value='<%# Eval("int_area_id") %>' />
                                            </ItemTemplate>
                                            <ItemStyle Width="20%" />
                                        </asp:TemplateField>
                                    </Columns>
