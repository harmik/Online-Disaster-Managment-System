...
public partial class AdminPages_designation : System.Web.UI.Page
{
    ...
    protected void btn_img_edit_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            string query = "select_tbl_designation";
            SqlCommand cm = new SqlCommand(query, cn);
            cm.CommandType = CommandType.StoredProcedure;

            cm.Parameters.AddWithValue("@cnd", " where int_designation_id=" + btn_img_edit.CommandArgument);
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                txt_designation_name.Text = ds.Tables[0].Rows[0]["str_designation_name"].ToString();
    ...
    protected void btn_img_delete_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            cm.Parameters.AddWithValue("@int_designation_id", btn_img_delete.CommandArgument);
    ...
    protected void btn_update_Click(object sender, EventArgs e)
    {
        ...
        {
            tbl_designation_BAL objbal = new tbl_designation_BAL();
            tbl_designation_DAL objdal = new tbl_designation_DAL();


            lblmsg.Visible = true;
            objdal.str_designation_name = txt_designation_name.Text;
            objdal.int_designation_id = Convert.ToInt16(ViewState["id"]);
    ...
    protected void btn_search_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                string query = "where str_designation_name like '" + txt_search_box.Text + "%'";
                binddata(query);
            }
        }
        catch (Exception ex)
        ...
        try
        {
            ...
            foreach (GridViewRow row in gvlist.Rows)
            {
                ...
                if (check.Checked)
                {
                    ...
                    objdal.int_designation_id = Convert.ToInt16(id.Value);
